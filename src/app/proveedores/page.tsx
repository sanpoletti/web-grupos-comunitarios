    ...
    /* OTRAS PROVINCIAS -> LOCALIDADES */
      ...
      const fetchLocalidades = async () => {
        ...
        try {
          ...
          const res = await fetch(`/api/localidades?provincia=${formData.provincia}`);
          const data = await res.json();
    ...
    const payload = {
      ...
      localidad:
        formData.provincia === '1'
          ? null
          : (formData.localidad ? Number(formData.localidad) : null),

      barrio:
        formData.provincia === '1'
          ? (formData.barrio ? Number(formData.barrio) : null)
          : null,
